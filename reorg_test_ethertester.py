...
def main():
    ...
    print(f"Baseline snapshot taken (pre-reveal fork): {snapshot_id}")
    ...
    print(f"Successfully reverted to snapshot {snapshot_id} — starting Branch B (canonical chain)")  
    ...
    if stateA["vuln_winner"] and stateA["vuln_winner"].lower() == malicious.lower():
        ...
        print("ℹ️VulnAuction branch A winner was not malicious or not set.")
